    ...
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          ...
          // Removed [&:has([aria-selected])]:bg-accent to prevent cell background conflict for single selected day
        ...
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground rounded-lg",
